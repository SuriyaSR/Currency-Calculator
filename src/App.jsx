...
function App() {
  ...
  const [convertedAmnt, setConvertedAmnt] = useState(null);
  ...
  useEffect(() => {
    if(exchangeRate !== null){
      setConvertedAmnt((amount * exchangeRate).toFixed(2));
    }
  }, [amount, exchangeRate]);
      ...
      <div className="currency-converter">
        ...
        <div className="data">
          ...
          <div className="input-container">
            ...
            <p>{amount} {fromCurrency} is equal to {convertedAmnt} {toCurrency}</p>
          </div>
        </div>
      </div>
    </>
